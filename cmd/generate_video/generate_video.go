...
func NewCommand(stdout, stderr io.Writer, runner *common.Runner) *cobra.Command {
	...
	flags.StringVar(&opts.Model, "model", "", "video model; normal users: seedance2.0_direct, seedance2.0_fast_direct, Seedance_2.0_mini; VIP users: seedance2.0_direct, seedance2.0_fast_direct, seedance2.0_vision, seedance2.0_fast_vision, Seedance_2.0_mini")
